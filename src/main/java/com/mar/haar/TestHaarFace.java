...
import static com.mar.utils.Utils.getAbsPathFromResources;
import static com.mar.utils.Utils.getFileFromResources;

public class TestHaarFace {
    ...
    public static void startHaar() throws URISyntaxException, FileNotFoundException {
        OpenCV.loadLocally();
